      ...
      <div className="max-w-6xl mx-auto">
              ...
              <Card className="bg-card-gradient border-primary/20">
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <a href="mailto:gsingh622@yahoo.com" className="text-foreground/80 hover:text-primary transition-colors">
                      gsingh622@yahoo.com
                    </a>
                  </div>
        ...
        <div className="mt-20 pt-8 border-t border-border/20 text-center">
          <p className="text-foreground/60">
            © 2025 GuriboyCodes. Built with React, Tailwind CSS, and lots of ☕
          </p>
