...
import ghibliImage from '../assets/me_ghibli.png';
      ...
      <Spotlight className="relative z-10 min-h-screen flex flex-col">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-center lg:text-left">
                ...
                <p className="text-xl md:text-2xl text-foreground/80 mb-8 max-w-3xl mx-auto lg:mx-0 leading-relaxed">
                  Staff Software Engineer (Mobile & AI) with over a decade of experience architecting production platforms and AI-powered systems for 90M+ users. 
                  Patent holder, technical leader, and hackathon veteran — from agentic AI systems to enterprise-scale mobile features.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start mb-8">
                  ...
                  <Button size="lg" variant="outline" className="border-primary/50 text-foreground hover:bg-primary/10" asChild>
                    <a href="/GurinderSingh-StaffSoftwareEngineer.pdf" download>
        ...
        <div className="py-8 border-t border-border/20">
          <Marquee className="text-foreground/60" speed={30}>
            ...
            <span className="mx-8">🤖 Agent0 — Autonomous AI Agent for Engineering</span>
